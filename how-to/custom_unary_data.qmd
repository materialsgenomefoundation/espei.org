...
[`generate_parameters` heading in ESPEI's YAML input](../reference/writing_input.qmd#generate_parameters). If you have ESPEI installed already, you can test that this
works by:
...
[@bocklund2019]. within the segmented
regression approach by [\[Roslyakova2016\]](#Roslyakova2016)[@roslyakova2016].
...
4.  In the `refstate.py` module, create the `Bockund2019Stable`,
    `Bockund2019`, and (optionally) `Bocklund2019SER` dictionaries (see [creating refstate dicts](#creating-the-reference-state-dictionaries) for more details)
...
[creating refstate dicts](#creating-the-reference-state-dictionaries) section above.
...
[skeleton package](#quickstart-skeleton-package) package from this repository,
you should find CustomRefstate2020 is printed and the dictionaries
