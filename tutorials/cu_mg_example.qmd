...
[YAML input schema](../reference/yaml_input_schema.qmd) page.
...
where `espei-in.yaml` is an [ESPEI input file](../reference/yaml_input_schema.qmd) with the following structure
