...
[YAML input schema](../reference/writing_input.qmd) page.
...
for which you should read the JSON section of the [dataset schema](../how-to/dataset_schema.qmd#json-format), or `DatasetError`, which are
...
[ESPEI input file](../reference/writing_input.qmd)
...
where `espei-in.yaml` is an [ESPEI input file](../reference/writing_input.qmd) with the following structure
