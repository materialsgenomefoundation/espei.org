...
data (see
[`fitting_description` in YAML input schema](../reference/writing_input.qmd#fitting_description) for more details).
...
files from [GitHub](https://github.com/bocklund/espei-elastic-parameter-generation)**.
...
[here](../how-to/dataset_schema.qmd#non_equilibrium_thermochemical_data) for
...
The [phase models description](../how-to/dataset_schema.qmd#phase-descriptions) defined in
